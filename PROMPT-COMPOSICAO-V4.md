# 📝 PROMPT-2: COMPOSIÇÕES v4.0 — PADRÃO OURO
...
**CHANGELOG v4.0:** Padrão Ouro — 19 melhorias aplicadas: Cronologia Oculta, Fronteira de Serviço, Observações por Insumo, HH Base/Fator/Ajustado + proibição HH redondo, Análise Percentual + Driver, NRs + tolerâncias + testes nomeados, Custo de Falha + ROI, 4 Blocos obrigatórios em 7.1 e 7.4, mín. 5 fontes com ícones de veredicto em 7.3, Template rico em 7.2, Premissas/Disclaimers, Tabela Comparativa, Cálculo de Derivação, Âncora de Sistema, Cópia de Modelos, Contextos Especiais, Script de Encerramento.
...
#### **5.1 ANÁLISE DE CUSTO + DRIVER PRINCIPAL (v4.0 — OBRIGATÓRIO)**
